...
during training.
\todo{Don't plagarize: Following Mozer (1994) we will train the network to
predict the probability density over all possible notes at time $t$ using as
input the note (and chord) values at time $t-1$}
